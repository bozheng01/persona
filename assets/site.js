    ...
    (function () {
      var DICT = {
        zh: {
          ...
          'Custom development of multimodal models for cognition, understanding, and generation, built around multimodal data such as graphics and images.': '围绕多模态数据（图形、图像等），进行认知、理解、生成的多模态模型定制化开发。',
          'Embodied AI': 'Embodied AI',
          'Custom development of World Action / Interaction Models for motion and interaction with the environment.': '动作与环境交互的 World Action / Interaction Model 的定制化开发。',
          'Build data from the perspective of each person — around personalized behavior and needs — while meeting privacy requirements.': '从每个人的角度出发，围绕个性化行为与需求构建数据，并满足隐私要求。',
          'Solutions for digital human expression across 2D/3D, motion, facial expression, voice, and more.': '数字人表达，覆盖 2D/3D、动作、表情、语音等领域的解决方案。',
          /* blog */
          'What we think': '我们的思考',
          'AI-Native Application Engineering Infrastructure': 'AI 原生应用工程基础设施',
          'Coming soon': '即将上线',
          /* about */
        ...
        ja: {
          ...
          'What we offer': '提供サービス', 'Live now': '公開中',
          ...
          'Your wardrobe, styled by AI.': 'AIが、あなたのワードローブをコーデに。',
          'Upload a photo and try on outfits in seconds. It reads your body and your style, then generates new looks you can actually wear.': '写真をアップロードするだけで、数秒で試着イメージが完成。体型や雰囲気を読み取り、実際に着られるコーデを提案します。',
          'Swap the top, the bottoms, or the whole outfit — and see it on you, not on a model.': 'トップスもボトムスも、全身まるごと。モデルではなく、あなた自身の姿で確認できます。',
          'AI try-on': 'AI試着', 'Instant outfits': 'すぐにコーデ', 'Your own photo': 'あなたの写真で',
          'Try it now': '試してみる',
          ...
          'Model Customization': 'モデルカスタマイズ',
          'Custom development of multimodal models for cognition, understanding, and generation, built around multimodal data such as graphics and images.': '図形や画像などのマルチモーダルデータを対象に、認知・理解・生成を担うマルチモーダルモデルをカスタム開発します。',
          'Embodied AI': 'Embodied AI',
          'Custom development of World Action / Interaction Models for motion and interaction with the environment.': '動作と環境のインタラクションを扱う World Action / Interaction Model をカスタム開発します。',
          'Build data from the perspective of each person — around personalized behavior and needs — while meeting privacy requirements.': '一人ひとりの視点に立ち、個別の行動やニーズに基づいてデータを構築し、プライバシー要件にも応えます。',
          'Solutions for digital human expression across 2D/3D, motion, facial expression, voice, and more.': 'デジタルヒューマンの表現を、2D/3D・動作・表情・音声などの領域でソリューションとして提供します。',
          'What we think': '私たちの考え',
          'AI-Native Application Engineering Infrastructure': 'AI ネイティブなアプリケーション開発基盤',
          'Coming soon': '近日公開',
